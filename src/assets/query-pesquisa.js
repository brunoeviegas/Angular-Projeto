...
(function (h) {
  ...
  function Ea(a) {
    ...
    if (a) {
      ...
      !a.sEmptyTable && (d && "Nenhuma linha com a inforamação solicitada" === b.sEmptyTable) && F(a, a, "sZeroRecords", "sEmptyTable");
  ...
  l.defaults = {
    ...
    oLanguage: {
      ...
      sEmptyTable: "Nenhuma informação para mostrar",
      sInfo: "Mostrando _START_ de _END_ de um total de _TOTAL_ linhas",
      sInfoEmpty: "Nada a mostrar por aqui",
      ...
      sSearchPlaceholder: "",
      sUrl: "",
      sZeroRecords: "Nenhuma informação para mostrar"
    },
